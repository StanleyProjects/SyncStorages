...
> GitHub [0.2.2u-SNAPSHOT](https://github.com/StanleyProjects/SyncStorages/releases/tag/0.2.2u-SNAPSHOT) release
>
...
dependencies {
    implementation("com.github.kepocnhh:SyncStorages:0.2.2u-SNAPSHOT")
}
```
