...
> GitHub [0.3.0u-SNAPSHOT](https://github.com/StanleyProjects/SyncStorages/releases/tag/0.3.0u-SNAPSHOT) release
>
...
dependencies {
    implementation("com.github.kepocnhh:SyncStorages:0.3.0u-SNAPSHOT")
}
```
